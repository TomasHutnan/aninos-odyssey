...
namespace AE.Audio
{
    public class AudioController : MonoBehaviour
    {
        ...
        public bool IsAudioTrackRunning(AudioType _type)
        {
            AudioTrack _audioTrackNeeded = GetAudioTrack(_type, "Get Audio Track Needed");
            AudioClip _audioClipNeeded = GetAudioClipFromAudioTrack(_type, _audioTrackNeeded);

            AudioSource _audioSource = GetAudioTrack(_type, "Get Audio Track Needed").source;
            AudioClip _audioClipPlaying = _audioSource.clip;

            return _audioSource.isPlaying && _audioClipNeeded == _audioClipPlaying;
        }
        #endregion
